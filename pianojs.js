...
document.querySelector(".sa").addEventListener("click",audio1.play());
document.querySelector(".re").addEventListener("click",audio2.play());
document.querySelector(".ga").addEventListener("click",audio3.play());
document.querySelector(".ma").addEventListener("click",audio4.play());
document.querySelector(".pa").addEventListener("click",audio5.play());
document.querySelector(".da").addEventListener("click",audio6.play());
document.querySelector(".ni").addEventListener("click",audio7.play());
